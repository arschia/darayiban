...
نسخه آزمایشی APK از داخل بخش «نصب برنامه» یا از [لینک مستقیم دانلود اندروید](https://darayiban.su-bifyt-ub.chatgpt.site/downloads/darayiban-android.apk) قابل دریافت است.
