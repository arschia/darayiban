...
اصلاح ثبت خودکار پیامک در [نسخه ۱.۱.۱](https://github.com/arschia/darayiban/releases/tag/android-v1.1.1) منتشر شده است. [راهنمای تغییرات و نصب](docs/ANDROID_1.1.1.md) را ببینید. APK از دامنه خود سایت به‌صورت مستقیم دانلود می‌شود.
...
نسخه آزمایشی ۱.۱.۱ همراه دستیار مالی Gemini از بخش «نصب برنامه» یا [دانلود مستقیم اندروید](https://selfmali.vercel.app/downloads/darayiban-android.apk) قابل دریافت است. با همان حساب وب وارد شوید و منوی «دستیار مالی» را باز کنید. [راهنمای نصب و تغییرات نسخه](docs/ANDROID_1.1.1.md) نکات نصب روی نسخه قبلی را توضیح می‌دهد.

ساخت Vercel با `scripts/prepare-android-download.mjs`، APK انتشار مشخص‌شده را دریافت و اندازه و SHA-256 آن را بررسی می‌کند؛ سپس فایل در `public/downloads/` قرار می‌گیرد و Vercel آن را مستقیماً سرو می‌کند. برای انتشار نسخه بعدی، URL، اندازه و هش اسکریپت و شماره نسخه در رابط و هدر دانلود را به‌روز کنید. دانلود کاربر به GitHub یا Google Drive هدایت نمی‌شود.
